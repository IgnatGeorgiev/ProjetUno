...
def verifieur(jeu,main) :  #Jeu est une liste 
    ...
    for e in main :
        if indiceVcarte(e)=='+2' and indiceVcouleur(e) == couleur : Indic = "Oui"  #Le joueur possède un +2 de meme couleur que la carte courante
        if indiceVnumero(e) == numero or indiceVcarte(e) == "+4" : Indic = "Oui"    #Le joueur possède une carte de meme numero que la carte courante ou un +4
